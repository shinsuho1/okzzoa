...
!function(e, t) {
    ...
    function P(t, e) {
        var r = e.s
          ...
          , o = v.indexOf(t)
          , i = n === ot.sc ? 1 : 2;
        return ~o || (o = v.push(t) - 1),
        v[o + i] || (v[o + i] = O(t, r) || (N(t) ? n : function(e) {
    ...
    function Ha(e, t) {
        if (V(e)) {
            ...
            e = e.substr(0, r - 1)),
            e = n + (e in C ? C[e] * t : ~e.indexOf("%") ? parseFloat(e) * t / 100 : parseFloat(e) || 0)
        }
        return e
    }
    function Ia(e, t, r, n, o, i, a) {
        ...
        return b += "position:" + (g && d ? "fixed;" : "absolute;"),
    ...
    function mb(e, t, r, n, o, i, a, s, l, c, u, f) {
        if (W(e) && (e = e(s)),
        V(e) && "max" === e.substr(0, 3) && (e = f + ("=" === e.charAt(4) ? Ha("0" + e.substr(3), r) : 0)),
        X(e))
            a && S(a, r, n, !0);
        else {
            W(t) && (t = t(s));
        ...
        if (i) {
            var b = e + r
              , x = i._isStart;
            f = "scroll" + n.d2,
            S(i, b, n, x && 20 < b || !x && (u ? Math.max(Pe[f], _e[f]) : i.parentNode[f]) <= b + 1),
            u && (l = it(a),
            u && (i.style[n.op.p] = l[n.op.p] - n.op.m - i._offset + rt))
        }
        return Math.round(e)
    }
    function ob(e, t, r, n) {
    ...
    function pb(l, e) {
        function Ye(e, t, r, n, o) {
            ...
            (t.modifiers = s)[p] = function(e) {
                return (e = K(f())) !== c && e !== u && 2 < Math.abs(e - c) ? (i.kill(),
                Ye.tween = 0) : e = r + n * i.ratio + o * i.ratio * i.ratio,
                u = c,
                c = K(e)
            }
            ,
        ...
        var c, u, f = P(l, e), p = "_scroll" + e.p2;
        return l[p] = f,
    ...
    var Se, i, Me, ke, _e, Pe, o, a, s, l, Ee, Ne, Ae, c, Be, Ie, u, Le, f, p, d, Re, ze, r, We, Ve, g, h, De = 1, Fe = [], v = [], He = Date.now, m = He(), je = 0, Ue = 1, Je = Math.abs, t = "scrollLeft", n = "scrollTop", b = "left", x = "right", y = "bottom", Xe = "width", Ze = "height", qe = "Right", $e = "Left", Ke = "Top", Qe = "Bottom", Ge = "padding", et = "margin", tt = "Width", w = "Height", rt = "px", nt = {
        s: t,
        p: b,
        p2: $e,
        os: x,
        ...
        o[r.p] = t + "px",
        Se.set(e, o)
    }, lt = [], ct = {}, k = {}, _ = [], E = [], A = function _dispatch(e) {
        ...
        if (!je || e) {
            ...
            Ca(ee, "scrollEnd", Va)
    }, D = 0, ut = 1, F = function _updateAll() {
        if (!h) {
            var e = lt.length
              , t = He()
              , r = 50 <= t - m
    ...
    }, H = [b, "top", y, x, et + Qe, et + qe, et + Ke, et + $e, "display", "flexShrink", "float", "zIndex", "grid-column-start", "grid-column-end", "grid-row-start", "grid-row-end", "grid-area", "justify-self", "align-self", "place-self"], j = H.concat([Xe, Ze, "boxSizing", "max" + tt, "max" + w, "position", et, Ge, Ge + Ke, Ge + qe, Ge + Qe, Ge + $e]), q = /([A-Z])/g, ft = function _setState(e) {
        if (e) {
    ...
    var ee = (ScrollTrigger.prototype.init = function init(S, M) {
        ...
        Ue) {
            ...
            }(M) : Se.utils.snap(pe.snapTo),
            p = pe.duration || {
                min: .1,
                max: 2
            },
            p = Y(p) ? Ne(p.min, p.max) : Ne(p, p),
            y = Se.delayedCall(pe.delay || o / 2 || .1, function() {
                if (Math.abs(we.getVelocity()) < 10 && !Ie && Oe !== we.scroll()) {
                    var e = M && !ge ? M.totalProgress() : we.progress
                      ...
                      , u = d.tween;
                    if (i <= A && E <= i && a !== i) {
                        if (u && !u._initted && u.data <= Math.abs(a - i))
                            return;
            ...
            (n = Se.core.getCache(ae)).spacer ? D = n.pinState : (n.spacer = j = ke.createElement("div"),
            ...
            we.revert = function(e) {
                ...
                }(ae, j, D) : de && we.isActive || gb(ae, j, ta(ae), $)),
                we.isReverted = t)
            }
            ,
                ...
                if (!Be && we.enabled || t)
                    if (ae && e && je)
                        ...
                        for (var r, n, o, i, a, s, l, c, u, f, p = Ce(), d = Te(), g = T(he, re), h = 0, v = 0, m = S.end, b = S.endTrigger || ie, x = S.start || (0 !== S.start && ie ? ae ? "0 0" : "0 100%" : 0), y = S.pinnedContainer && Ee(S.pinnedContainer)[0], w = ie && Math.max(0, lt.indexOf(we)) || 0, C = w; C--; )
                            ...
                            !(l = s.pin) || l !== ie && l !== ae || s.isReverted || ((f = f || []).unshift(s),
                            s.revert());
                        for (E = mb(x, ie, p, re, we.scroll(), B, L, we, d, ye, me, g) || (ae ? -.001 : 0),
                        W(m) && (m = m(we)),
                        V(m) && !m.indexOf("+=") && (~m.indexOf(" ") ? m = (V(x) ? x.split(" ")[0] : "") + m : (h = Ha(m.substr(2), p),
                        m = V(x) ? x : E + h,
                        b = ie)),
                        A = Math.max(E, mb(m || (b ? "100% 0" : g), b, p, re, we.scroll() + h, I, R, we, d, ye, me, g)) || -.001,
                        z = A - E || (E -= .01) && .001,
                        h = 0,
                        C = w; C--; )
                        ...
                        ae)
                            ...
                            me && ((a = {
                                ...
                                position: "fixed"
                            })[Xe] = a.maxWidth = Math.ceil(n.width) + rt,
            ...
            we.update = function(e, t) {
                var r, n, o, i, a, s = we.scroll(), l = e ? 0 : (s - E) / z, c = l < 0 ? 0 : 1 < l ? 1 : l || 0, u = we.progress;
                if (t && (_ = k,
                k = s,
                pe && (x = b,
                b = M && !ge ? M.totalProgress() : c)),
                ce && !c && ae && !Be && !De && je && E < s + (s - _) / (He() - Ae) * ce && (c = 1e-4),
                c !== u && we.enabled) {
                    if (i = (a = (r = we.isActive = !!c && c < 1) != (!!u && u < 1)) || !!c != !!u,
                    we.direction = u < c ? 1 : -1,
                    we.progress = c,
                    ge || (!K || Be || De ? M && M.totalProgress(c, !!Be) : (K.vars.totalProgress = c,
                    K.invalidate().restart())),
                    ae)
                        if (e && se && (j.style[se + re.os2] = h),
                        me) {
                            if (i) {
                                if (o = !e && u < c && s < A + 1 && s + 1 >= T(he, re),
                                de)
                                    if (e || !r && !o)
                                        ob(ae, j);
                                    else {
                                ...
                                ft(r || o ? F : H),
                                q !== z && c < 1 && r || g(Z + (1 !== c || o ? 0 : q))
                            }
                        } else
                            g(Z + q * c);
                    !pe || d.tween || Be || De || y.restart(!0),
                    C && (a || fe && c && (c < 1 || !We)) && Ee(C.targets).forEach(function(e) {
                        return e.classList[r || fe ? "add" : "remove"](C.className)
                    }),
                    !w || ge || e || w(we),
                    i && !Be ? (n = c && !u ? 0 : 1 === c ? 1 : 1 === u ? 2 : 3,
                    ge && (o = !a && "none" !== xe[n + 1] && xe[n + 1] || xe[n],
                    M && ("complete" === o || "reset" === o || o in M) && ("complete" === o ? M.pause().totalProgress(1) : "reset" === o ? M.restart(!0).pause() : "restart" === o ? M.restart(!0) : M[o]()),
                    w && w(we)),
                    !a && We || (ne && a && ne(we),
                    be[n] && be[n](we),
    ...
    ScrollTrigger.register = function register(e) {
        ...
        Pe))) {
            ...
            j.push(u),
            i = He(),
            a = Se.delayedCall(.2, z).pause(),
            d = [ke, "visibilitychange", function() {
                var e = Me.innerWidth
                  , t = Me.innerHeight;
                ke.hidden ? (f = e,
                p = t) : f === e && p === t || Oa()
    ...
    ScrollTrigger.matchMedia = function matchMedia(e) {
        ...
        for (r in e)
            n = E.indexOf(r),
            o = e[r],
            "all" === (Ve = r) ? o() : (t = Me.matchMedia(r)) && (t.matches && (i = o()),
            ~n ? (E[n + 1] = $(E[n + 1], o),
            E[n + 2] = $(E[n + 2], i)) : (n = E.length,
            E.push(r, o, i),
    ...
    ee.saveStyles = function(e) {
        return e ? Ee(e).forEach(function(e) {
            if (e && e.style) {
                var t = B.indexOf(e);
                0 <= t && B.splice(t, 5),
                B.push(e, e.style.cssText, e.getBBox && e.getAttribute("transform"), Se.core.getCache(e), Ve)
            }
        }) : B
    }
    ,
